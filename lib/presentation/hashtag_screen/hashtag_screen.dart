...
class HashtagScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<HashtagBloc>(
        create: (context) =>
            HashtagBloc(HashtagState(hashtagModelObj: HashtagModel()))
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: BlocSelector<HashtagBloc, HashtagState,
                                  HashtagModel?>(
                              selector: (state) => state.hashtagModelObj,
                              builder: (context, hashtagModelObj) {
                                return GridView.builder(
                                    ...
                                    itemCount: hashtagModelObj
                                            ?.hashtagItemList.length ??
                                        0,
                                    itemBuilder: (context, index) {
                                      HashtagItemModel model = hashtagModelObj
                                              ?.hashtagItemList[index] ??
                                          HashtagItemModel();
                                      return HashtagItemWidget(model);
                                    });
                              }))
                    ]))));
  }
